...
% Autor: Arthur Lins de Vasconcellos, Pedro Forlevezi, Pedro Ribbe de Vasconcellos e Pedro Rezende  |  Compila com pdflatex (Overleaf-friendly).
...
% --- Metadados ---
\title{%
  \textbf{CompStat Rio- Claude Impact Lab Rio de Janeiro} \\[0.4em]
  \large{Guia de Leitura da Aplicação} \\[0.3em]
  \normalsize\itshape Inteligência territorial para segurança pública municipal
}
\author{Arthur Vasconcellos, Pedro Forlevezi, Pedro Ribbe e Pedro Rezende}
\date{\today}
...
\begin{titlepage}
  ...
  {\large \textbf{Arthur Vasconcellos, Pedro Forlevezi, Pedro Ribbe e Pedro Rezende}} \\[0.3cm]
  {\large \today}
  \vfill
